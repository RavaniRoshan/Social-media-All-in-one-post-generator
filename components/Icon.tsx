...
interface IconProps extends React.SVGProps<SVGSVGElement> {
  icon: 'linkedin' | 'instagram' | 'x' | 'download' | 'edit' | 'copy' | 'check' | 'chevron-down' | 'upload';
}
...
export const Icon: React.FC<IconProps> = ({ icon, className, ...props }) => {
  const icons = {
    ...
    x: (
        <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className={className}>
